...
use Illuminate\Support\Facades\Log; // Para registro de logs
...
class WebytePayController extends Controller
{
    ...
    public function createTransaction(Request $request)
    {
        $request->validate([
            ...
            'payment_method' => 'required|string|in:pix,boleto,cartao', // Validação do método de pagamento
        ]);
        ...
        try {
            ...
            return response()->json([
                'success' => false,
                'message' => 'Erro ao criar a transação. Por favor, tente novamente.',
            ], 500);
        }
    }
